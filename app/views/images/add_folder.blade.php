<div class="row height addFolderWrapper collection-form col-md-4" >
    <div class="height" style="width:100%;padding-right: 0px !important;">
        <div class="height collectionBox">
            <p class="title-name"><i class="fa fa-tags"></i>Add folder</p>

            <div class="cloHeight content_list" id="container_content">
                {{ Form::open(array(
                'url' => 'add_to_folder',
                ...
                <div class="control-group text-left">
                    {{ Form::label('Name', 'Name', array('class' => 'control-label text-left')) }}
                    <div class="controls">
                ...
                <div class="input-group saveBtn">
                    <div class="controls">
                        {{ Form::submit('Save', array('class' => 'btn btn-inverse add-folder')) }}
                    </div>
                </div>
