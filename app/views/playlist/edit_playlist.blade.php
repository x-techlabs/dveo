    ...
    <div class="col-md-4 height" id="add-playlist">
        ...
        <div class="addPlaylist height content">
            ...
            <div class="videoHeightedit content_list">
                ...
                <!-- Stream url -->
                <div class="control-group">
                    {{ Form::label('stream_url', 'Stream URL', array('class' => 'control-label')) }}
                    <div class="controls">
                        {{ Form::text('stream_url', $playlist->stream_url, array('class' => 'form-control z-index-1', 'id' => 'stream_url')) }}
                    </div>
                </div>
                <!-- Description -->
                <div class="control-group">
                ...
                <div class="input-group saveBtn">
                    <div class="controls">
                        {{ Form::button('Save', array('class' => 'btn btn-inverse', 'onclick' => 'edit_playlist_button_clicked()')) }}
