	                            ...
	                            <script src="http://1stud.io/js/videojs_snapshot_580/demo/javascript/plupload.full.min.js"></script>
                                 ...
                                 <div width="510px" id="localcontainer">
                                    ...
                                    <video id="local" class="video-js vjs-default-skin" controls preload="none" width="510" height="264"
                                        data-setup="{}">
                                        <source type="video/mp4" src="http://{{$file_bucket}}.s3.amazonaws.com/{{$desc->file_name}}.mp4"/>
...
// 			                        previewContainer: ".preview",
// 			                        debuglog: true,
// 			                        //s3url: "//aceplayout.s3-region.amazonaws.com",
// 			                        s3url : "//aceplayout.s3.amazonaws.com",
// 			                        s3: {
// 			                        "Content-Type":"image\/jpeg",
// 			                        "acl":"public-read",
// 			                        "success_action_status":"201",
// 			                        "policy":"{{$policy}}",
// 			                        "X-amz-credential":"AKIAJWU4DYR6OMHE2YPQ\/timestamp\/region\/s3\/aws4_request",
...
// 			                        });
	                                 ...
	                                 var uploader = new plupload.Uploader({
                                        ...
                                        dragdrop: false,
                                        flash_swf_url : 'http://1stud.io/js/videojs_snapshot_580/demo/javascript//Moxie.swf'
                                    });
